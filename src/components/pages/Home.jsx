...
export default function () {
  ...
  return (
    <>
      <section
  className="bg-[url('images/hero.jpg')] bg-cover bg-center h-screen flex flex-col justify-center items-center text-white"
>
  <h1 className="text-center text-6xl font-bold py-8">
    Discover the Future of AI Tools {count}
  </h1>

  <button onClick={changeCount} className="block mx-auto p-3 bg-red-500 text-white">
    Explore Tools
  </button>
  ...
  <div className="max-w-[1320px] mx-auto px-4">
    ...
    <p className="text-center text-gray-600 mt-4 max-w-[700px] mx-auto">
      AI assistants help users generate content, automate tasks,
      answer questions, and improve workflow efficiency.
    </p>
  ...
  <div className="max-w-[1320px] mx-auto px-4 mt-24">
    ...
    <p className="text-center text-gray-600 mt-4 max-w-[700px] mx-auto">
      Creative AI tools help users generate images, videos,
      designs, and visual content within seconds.
    </p>
  ...
  return (
    <div>
      <div className="bg-neutral-primary-soft block max-w-sm border border-default rounded-2xl overflow-hidden bg-white shadow-lg hover:scale-105 duration-300">
        <a href="#">    
          <img className="rounded-t-base w-full h-[300px] object-cover" src={images} alt={title} />
        </a>
